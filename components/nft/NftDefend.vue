<template>
    <div class="nftUpgrade">
      <div class="nftUpgrade__info grid gap--16 alignI--end">
        <p class="nftUpgrade__infoLabel fc--para ff--slab fs--16">Buccaneerdsfdsafefe:</p>
      ...
      <BaseBtn class="nftUpgrade__upgradeBtn" @click="defendModal(pirate.id)">Defend Buccaneer</BaseBtn>
    </div>
  </template>
